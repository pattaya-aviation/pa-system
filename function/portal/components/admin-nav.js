...
function renderMobileMenu(currentPage) {
    ...
    return `
        <div class="admin-mobile-nav fixed top-4 right-4 z-50">
            ...
            <div id="adminMobileMenu" class="hidden absolute top-16 right-0 w-56 bg-white/95 backdrop-blur-xl rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                <nav class="py-2">
                    ${menuItems}
