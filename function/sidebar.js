...
function createSidebarHTML(currentPage = 'home') {
  ...
  return `
    ...
    <!-- Sidebar -->
    <div id="sidebar" class="fixed top-0 left-0 w-72 bg-white z-[60] transform -translate-x-full transition-transform duration-300 shadow-2xl" style="height: 100vh; height: 100dvh; min-height: -webkit-fill-available;">
